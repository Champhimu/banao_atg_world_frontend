  ...
  return (
    ...
    <button className='closebtn' style={{position: 'relative', backgroundColor: 'white', border: 'none', top: '14%', left: '75%', borderRadius: '100%', opacity: '0.7'}} type="button" data-bs-dismiss="modal" aria-label="Close"><MdOutlineClose fontSize={'1.5em'} style={{}} /></button> 
            ...
            <div class="offcanvas-body">
                ...
                <button onClick={() => isSignedIn(true)} data-bs-dismiss="offcanvas" style={{height: '45px', marginTop: '15px', borderRadius: '25px', width: '100%'}} type="button" class="btn btn-primary w-50">Sign In</button>
                ...
                <br />
                <button onClick={() => isSignedIn(true)} data-bs-dismiss="offcanvas" style={{height: '40px', marginBottom: '10px', width: '100%', borderColor: '#D9D9DB'}} class="btn btn-sm" type="button">
                <FaFacebook color='blue' fontSize={'1.2em'}/> Sign up with Facebook
                </button>
                <button onClick={() => isSignedIn(true)} data-bs-dismiss="offcanvas" style={{height: '40px', marginBottom: '20px', width: '100%', borderColor: '#D9D9DB'}} class="btn btn-sm" type="button">
                <FcGoogle fontSize={'1.2em'} /> Sign up with Google
                </button>
