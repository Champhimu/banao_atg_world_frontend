...
<div class="modal fade" id="staticBackdrop" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <button className='closebtn' style={{position: 'relative', border: 'none', top: '14%', left: '75%', borderRadius: '100%', backgroundColor: 'white', opacity: 0.7}} type="button" data-bs-dismiss="modal" aria-label="Close"><MdOutlineClose fontSize={'1.5em'} style={{}} /></button> 
...
<div style={{borderRadius: '8px 8px 0px 0px', height: '500px'}} class="offcanvas offcanvas-bottom" tabindex="-1" id="createaccountcanvas" aria-labelledby="offcanvasBottomLabel">
            <div class="offcanvas-header">
                ...
                <button style={{marginBottom: '-5px'}} type="button" class="btn text-reset" data-bs-dismiss="offcanvas" aria-label="Close"><MdOutlineClose color='white' style={{backgroundColor: 'black', borderRadius: '50%', fontSize: '1.2em'}} /></button>
            </div>
            <div class="offcanvas-body">
                ...
                <button onClick={() => setIsSignedIn(true)} data-bs-dismiss="offcanvas" style={{height: '45px', marginTop: '15px', borderRadius: '25px', width: '100%'}} type="button" class="btn btn-primary w-50">Create Account</button>
                <p data-bs-toggle="offcanvas" data-bs-target="#signupcanvas" aria-controls="offcanvasBottom" style={{color: '#495057', textDecoration:'underline', cursor: 'pointer', marginTop: '25px', marginBottom: '5px'}}>or, Sign In</p>
                </div>
                <br />
                <button onClick={() => setIsSignedIn(true)} data-bs-dismiss="offcanvas" style={{height: '40px', marginBottom: '10px', width: '100%', borderColor: '#D9D9DB'}} class="btn btn-sm" type="button">
                    {/* <img alt='fb sign up' src={fblogo} /> */}
                    <FaFacebook color='blue' fontSize={'1.2em'}/> Sign up with Facebook
                </button>
                <button onClick={() => setIsSignedIn(true)} data-bs-dismiss="offcanvas" style={{height: '40px', marginBottom: '20px', width: '100%', borderColor: '#D9D9DB'}} class="btn btn-sm" type="button">
                    {/* <img alt='google sign up' src={glogo} /> */}
                    <FcGoogle fontSize={'1.2em'} /> Sign up with Google
                </button>
